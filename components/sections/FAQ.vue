<template>
  <UiSectionWrapper class="py-20 md:py-32 bg-backgroundColor">
    <UiSectionContainer class="text-center">
      ...
      }" class="font-semibold text-[28px] md:text-[32px] lg:text-[36px] text-black mb-12">
      ...
      <div class="w-full space-y-4">
        ...
        >
          ...
          >
            <span class="font-medium text-[16px] md:text-[18px] text-black pr-4">
              {{ faqItem.question }}
            </span>
